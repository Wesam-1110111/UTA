...
<section class="main-grid">
    ...
    <main class="main-content">
        <header class="common-header" style="display: flex; align-items: center !important;">
            ...
            <a href="{{route('showchattc')}}" style="color: #333;">
        ...
        <div class="messanger">
            <ol class="messanger-list">
                ...
                @if (strpos( $chat->body, 'student' ) !== FALSE)
            ...
            <form action="{{route('sendchatuser',$id)}}" method="POST">
                @csrf
