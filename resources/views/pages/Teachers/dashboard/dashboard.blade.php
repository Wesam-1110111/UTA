                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    ...
                                    <h4>{{App\Models\Subject::where('teacher_id',auth()->user()->id)->count()}}</h4>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    ...
                                    <h4>{{App\Models\Lectures::where('teacher_id',auth()->user()->id)->count()}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{ route('Lectures.index') }}" target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab nav-border" style="position: relative;">
                                <div class="d-block d-md-flex justify-content-between">
                                    <div class="d-block w-100">
                                        <h5 style="font-family: 'Cairo', sans-serif" class="card-title">اخر الإشعارات</h5>
                                    </div>
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active show" id="students-tab" data-toggle="tab"
                                                   ...
                                                   aria-selected="true"> الإشعارات</a>
                                            </li>
                                    ...
                                    <div class="tab-pane fade active show" id="students" role="tabpanel" aria-labelledby="students-tab">
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                @forelse(\App\Models\Notification::where('rools',1)->where('classroom_id',Auth::user()->Classroom_id)->latest()->take(5)->get() as $Notification)
                                                @include('pages.Teachers.dashboard.not')
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            title="عرض"><i  class="far fa-eye "></i></button>
                                                        </td>
                                                        <td class="text-success">{{$Notification->created_at}}</td>
                                                        @empty
                                                            <td class="alert-danger" colspan="8">لاتوجد إشعارات</td>
                                                    </tr>
