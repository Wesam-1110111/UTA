                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a class="dropdown-item" href="{{route('Summaries_teacher.show',[$Summary->id])}}"><i style="color: green" class="fa fa-check"></i>&nbsp;  الموافقة على الطلب</a>
                                                            <a class="dropdown-item" href="{{route('Summaries_teacher.edit',$Summary->id)}}"><i style="color:rgb(202, 62, 62)" class="fa fa-times"></i>&nbsp;  إلغاء الطلب</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
