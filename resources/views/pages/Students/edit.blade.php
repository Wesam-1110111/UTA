            ...
            <div class="card-body">
                ...
                @endif
                    ...
                    <form action="{{route('Students.update','test')}}" method="post" autocomplete="off">
                        @method('PUT')
                        @csrf
                    <h6 style="font-family: 'Cairo', sans-serif;">{{trans('Students_trans.personal_information')}}</h6><br>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->r_number}}" class="form-control" name="r_number" type="number" >
                                </div>
                            </div>
                        </div>
                    ...
                    <h6 style="font-family: 'Cairo', sans-serif;">{{trans('Students_trans.Student_information')}}</h6><br>
                    <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
