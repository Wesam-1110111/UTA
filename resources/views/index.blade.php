...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href= "{{asset('index/css/fontawesome.css')}}">
    <link rel="stylesheet" href= "{{asset('index/css/templatemo-space-dynamic.css')}}">
    <link rel="stylesheet" href= "{{asset('index/css/animated.css')}}">
    <link rel="stylesheet" href= "{{asset('index/css/owl.css')}}">
<!--
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><div class="main-red-button"><a href="{{route('rigesterr')}}">إنشاء حساب</a></div></li>
            </ul>
            ...
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <div style="display: flex; justify-content: center;">
                  <div class="main-red-button" style="margin: 0 5px"><a href="{{route('rigesterr')}}">إنشاء حساب</a></div>
                  <div class="main-red-button" style="margin: 0 5px"><a href="{{route('selectionn')}}">تسجيل دخول</a></div>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{asset('index/images/first_sec_img.jpg')}}" alt="team meeting">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <img src="{{asset('index/images/-5900010619514503757_120-removebg-preview.png')}}" alt="person graphic">
          </div>
        </div>
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="hidden-content">
                <h4>{{$item->Name}}</h4>
                <div><a href="{{route('rigesterr')}}" style="display: inline-block; background-color: #fff; font-size: 15px; font-weight: 400; color: #37b7c3; text-transform: capitalize; padding: 12px 25px; border-radius: 23px; letter-spacing: 0.25px;">انظم الأن</a></div>
              </div>
              <div class="showed-content">
                <img src="{{asset('attachments/logo/' . $item->file_name)}}" alt="">
              </div>
            </div>
          </a>
        </div>
  ...
  <script src= "{{asset('index/js/animation.js')}}"></script>
  <script src= "{{asset('index/js/imagesloaded.js')}}"></script>
  <script src= "{{asset('index/js/templatemo-custom.js')}}"></script>
