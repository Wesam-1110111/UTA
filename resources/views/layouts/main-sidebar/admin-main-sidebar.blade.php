...
<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- students-->
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#students-menu"><i class="fas fa-user-graduate"></i>{{trans('main_trans.students')}}<div class="pull-right"><i class="ti-plus" style="color: #777;"></i></div><div class="clearfix"></div></a>
        ...
        <li>
            ...
            <ul id="Lectures-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('ALectures.index') }}">قائمة المحاضرات </a> </li>
        ...
        {{-- <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#library-icon">
                <div class="pull-left"><i class="fas fa-book"></i><span class="right-nav-text">شيتات</span></div>
                <div class="pull-right"><i class="ti-plus" style="color: #777;"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">قائمة الشيتات</a> </li>
            </ul>
        </li> --}}
                ...
                <li>
                    <a href="{{ route('R_Teachers.index') }}">
                        <div class="pull-left"><i class="ti-home"></i><span class="right-nav-text">طلبات أعضاء هيئة التدريس (<span class="text-danger">{{App\Models\Teacher::where('status',0)->count()}}</span>)</span>
                        </div>
                        <div class="clearfix"></div>
                    </a>
                </li>
                ...
                <!-- Notifications-->
                {{-- <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#Notifications-icon">
                        <div class="pull-left"><i class="fas fa-book"></i><span class="right-nav-text">الإشعارات</span></div>
                        <div class="pull-right"><i class="ti-plus"></i></div>
                        <div class="clearfix"></div>
                    </a>
                    <ul id="Notifications-icon" class="collapse" data-parent="#sidebarnav">
                        <li> <a href="{{route('Notifications.index')}}">قائمة الإشعارات</a> </li>
                    </ul>
                </li> --}}
