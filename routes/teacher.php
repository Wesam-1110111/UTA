...
use App\Http\Livewire\Chat\Chattech;
...
Route::group(
    [
        ...
        'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath', 'auth:teacher' , 'tech']
    ], function () {

                //============================== Requests summaries ============================
                Route::group(['namespace' => 'Teachers\dashboard'], function () {
                    Route::resource('Summaries_teacher', 'T_Requests_SummariesController');
                });
...
//        $count_students = DB::table('students')->whereIn('section_id',$ids)->count();
    ...
    Route::get('showchattc/{id?}',  [Chattech::class, 'chat'])->name('showchattc');
    Route::post('sendchatuser/{id}',  [Chattech::class, 'store'])->name('sendchatuser');
    ...
    //  Route::resource('library', 'LibraryController');
     Route::resource('Techlibrary', 'TechLibraryController');
     Route::resource('Lectures', 'LectureController');
     Route::resource('viewers', 'ViewersController');
