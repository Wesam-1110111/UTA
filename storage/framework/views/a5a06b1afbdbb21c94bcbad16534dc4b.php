                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a class="dropdown-item" href="<?php echo e(route('Summaries_teacher.show',[$Summary->id])); ?>"><i style="color: green" class="fa fa-check"></i>&nbsp;  الموافقة على الطلب</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('Summaries_teacher.edit',$Summary->id)); ?>"><i style="color:rgb(202, 62, 62)" class="fa fa-times"></i>&nbsp;  إلغاء الطلب</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Ahlia_University\resources\views/pages/Teachers/dashboard/summaries/summaries.blade.php ENDPATH**/ ?>