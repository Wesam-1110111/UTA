<div class="modal fade" id="delete_book<?php echo e($Lecture->id); ?>" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <form action="<?php echo e(route('ALectures.destroy','test')); ?>" method="post">
...
<?php /**PATH C:\xampp\htdocs\Tripoli_University\resources\views/pages/lecture/destroy.blade.php ENDPATH**/ ?>