                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12"><br>
                            ...
                            <button class="btn btn-danger btn-sm nextBtn btn-lg pull-right" type="button"
                                    wire:click="back(2)"><?php echo e(trans('Parent_trans.Back')); ?></button>

                            <?php if($updateMode): ?>
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="submitForm_edit"
                                        type="button"><?php echo e(trans('Parent_trans.Finish')); ?>

                                </button>
                            <?php else: ?>
                                <button class="btn btn-success btn-sm btn-lg pull-right" wire:click="submitForm"
                                        type="button"><?php echo e(trans('Parent_trans.Finish')); ?></button>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Tripoli_University\resources\views/livewire/add-parent.blade.php ENDPATH**/ ?>