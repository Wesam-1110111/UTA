...
unset($__errorArgs, $__bag); ?>
                            ...
                            <br>
                            <?php if($type == 'student'): ?>
                            <a href="<?php echo e(route('rigesterr')); ?>" style="color: #37b7c3; text-align: center; font-size: 18px;"  class="float-left"><span style="color: #393737">ليس لديك حساب؟</span> إنشاء حساب جديد </a>
                            <?php elseif($type == 'teacher'): ?>
                            <a href="<?php echo e(route('rigestertech')); ?>" style="color: #37b7c3; text-align: center; font-size: 18px;"  class="float-left"><span style="color: #393737">ليس لديك حساب؟</span> إنشاء حساب جديد </a>
...
<?php /**PATH C:\xampp\htdocs\Tripoli_University\resources\views/auth/login.blade.php ENDPATH**/ ?>