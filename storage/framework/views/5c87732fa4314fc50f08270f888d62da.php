...
<section class="main-grid">
    <aside class="main-side">
        ...
        <section class="chats">
            <ul class="chats-list" style="padding: 10px; border-bottom: 1px solid #6c757d42">
                ...
                <?php $__currentLoopData = $get_teacher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                <a href="<?php echo e(route('showchat',$teacher->teacher->id)); ?>">
                    <li class="chats-item" style="list-style: none;">
                        
                        <div class="chats-item-button js-chat-button" role="button" tabindex="0">
                            <img class="profile-image" src="<?php echo e(asset('./assets/images/teacher.png')); ?>"
                                    alt="Rachel Bratt Tannenbaum">
                            
                            <header class="chats-item-header">
                                <h5 cwlass="chats-item-title"><?php echo e($teacher->teacher->Name); ?>
    ...
    <main class="main-content">
        <header class="common-header" style="display: flex; align-items: center !important;">
            ...
            <a href="<?php echo e(route('showchat')); ?>" style="color: #333;">
        ...
        <div class="messanger">
            <ol class="messanger-list" style="direction:ltr">
                ...
                <?php if(strpos( $chat->body, 'techer' ) !== FALSE): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tripoli_University\resources\views/livewire/chat/form_chat.blade.php ENDPATH**/ ?>