...
<section class="main-grid">
    <aside class="main-side">
        ...
        <section class="chats">
            <ul class="chats-list" style="padding: 10px; border-bottom: 1px solid #6c757d42">
                ...
                <a href="<?php echo e(route('showchattc',$student->student->id)); ?>">
                    <li class="chats-item" style="list-style: none;">
                        
                        <div class="chats-item-button js-chat-button" role="button" tabindex="0">
                            <img class="profile-image" src="<?php echo e(asset('./assets/images/my_son.png')); ?>"
                                    alt="Rachel Bratt Tannenbaum">
                            
                            <header class="chats-item-header">
                                <h5 cwlass="chats-item-title"><?php echo e($student->student->name); ?>

                                    <span tabindex="0" style="color:red">
                                        
                                            <?php if($id == null): ?>
                                            <?php $__currentLoopData = $countmsgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $countmsg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            
                                            if($countmsg->student_id == $student->student->id && $countmsg->read == 0) {
                                                 $sum++;
                                            }
                                            ?>
    ...
    <main class="main-content">
        <header class="common-header" style="display: flex; align-items: center !important;">
            ...
            <a href="<?php echo e(route('showchattc')); ?>" style="color: #333;">
        ...
        <div class="messanger">
            <ol class="messanger-list">
                ...
                <?php if(strpos( $chat->body, 'student' ) !== FALSE): ?>
                <li class="common-message is-you no" >
                    <p class="common-message-content" >
                        
                        <?php echo e(substr($chat->body, 8)); ?>

                        
                    </p>
                    <time style="font-size:10px/*rtl:14px*/;" datetime><?php echo e($chat->created_at); ?></time>
                </li>
                    <?php else: ?>
                    <li class="common-message is-other" >
                    
                        <p class="common-message-content" style="direction:ltr">
                            <?php echo e(substr($chat->body, 7)); ?>
            ...
            <form action="<?php echo e(route('sendchatuser',$id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                  <div class="message-box">
      
                      <input class="text-input" id="message-box" name="message" placeholder="Type a message" autocomplete="off" contenteditable>
                      <input type="hidden" value="<?php echo e($id); ?>" name="student_id">
    ...
    <?php else: ?>
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; background-image: url(<?php echo e(asset('index/images/top-view-speech-bubbles-megaphones.jpg')); ?>); background-size: cover; position: relative;">
        <div class="trans-ground" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; right: 0; bottom: 0; background: #000; opacity: 0.2;
            "></div>
        <div class="mb-3" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding: 25px; z-index: 100; border-radius: 50px; width: fit-content; background-color: #eee;">
            <span><i class="fa-solid fa-comment-dots" style="font-size: 42px;"></i></span>
        </div>
        <div class="mt-3" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding: 15px; z-index: 100; border-radius: 4px; width: fit-content; background-color: #eee;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tripoli_University\resources\views/livewire/chat/form_chattech.blade.php ENDPATH**/ ?>