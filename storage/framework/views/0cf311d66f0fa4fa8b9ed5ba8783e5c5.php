            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="<?php echo e(route('ALectures.update','test')); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Teacher_id">
                                                ...
                                                <?php $__currentLoopData = $Teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($Teacher->id); ?>" <?php echo e($Teacher->id == $Lecture->teacher_id  ? 'selected' : ""); ?>><?php echo e($Teacher->Name); ?></option>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Subject_id">
                                                <option value="<?php echo e($Lecture->subject_id); ?>"><?php echo e($Lecture->subject->name); ?></option>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tripoli_University\resources\views/pages/lecture/edit.blade.php ENDPATH**/ ?>