...
class RepoServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('App\Repository\TechLibraryRepositoryInterface', 'App\Repository\TechLibraryRepository');
        $this->app->bind('App\Repository\LectureRepositoryInterface', 'App\Repository\LectureRepository');
        $this->app->bind('App\Repository\CoursesRepositoryInterface', 'App\Repository\CoursesRepository');
        $this->app->bind('App\Repository\AdminLectureRepositoryInterface', 'App\Repository\AdminLectureRepository');
