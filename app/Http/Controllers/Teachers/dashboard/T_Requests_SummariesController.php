...
class T_Requests_SummariesController extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        $Summaries = Summary::where('classroom_id',auth()->user()->Classroom_id)->where('status',0)->with('grade','classroom','subject')->get();
        return view('pages.Teachers.dashboard.summaries.summaries',compact('Summaries'));
    }
